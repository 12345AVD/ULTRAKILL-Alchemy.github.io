...
## The Tree of Life and The Philosopher's Stone
![](images/7-1-StartingGardenCrosses.png)<br>
...
![](images/8-1-LionEatingSunStatue.png)<br>
A completed version of the statue can be found all around 8-1, with "Creation of the Tree of Life" engraved below it.<br>
This could be a reference to the alchemical imagery of aqua regia, a green lion attacking the sun. Where the lion is the aqua regia attacking/consuming the sun which is gold (https://en.wikipedia.org/wiki/Suns_in_alchemy) or could be a reference to the Demiurge(false god) represented by the Lion stealing divine power from the true God represented by the Sun in order to create the material world.<br>

## The Seven Classical Planets and 5 Archangels
In the final section of 8-3, the walls fall over to reveal the cosmos whith the seven Classical Planets(Sun, Moon, Mercury, Venus, Mars, Jupiter, Saturn) alonside Earth.
![](images/WikPlanetaryAlchemicalMetals.png)<br>
![](images/WikClassicalPlanet.png)<br>
The 7 planets correspond to 7 alchemical metals. Furthermore, the correspond to Roman, Greek, Norse, Saxon as well as Hindu, Babylonian, Armenian and Egyptian(not shown) Gods. 
![](images/8-1-Archangels.png)<br>
![](images/8-1-ArchangelsHighDetail.png)<br>
![](images/8-1-ArchangelsScratchedOutMetaphor.png)<br>
In 8-1, a painting of 5 Archangels can be seen with metaphors relating to God. The second to last one is scratech out however but closely examining its plaque it most likely reads, "LUCIFER  God's Kindness" 
